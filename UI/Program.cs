...
//p.AsignarPermisos<Familia, Patente>(new Familia(Guid.Parse("6F5E615B-70C2-4B05-AAF7-C12F88D3645A")), patentes);

p.CambiarHabilitado(new Familia(Guid.Parse("6F5E615B-70C2-4B05-AAF7-C12F88D3645A")), patentes);
