        ...
        internal class CanchaAdapter
        {
            ...
            public Cancha Get(object[] values)
            {
                ...
                return new Cancha
                {
                    ...
                    FranjaHoraria = values[6] == DBNull.Value ? null : values[6].ToString(),
                    Nombre = values[7] == DBNull.Value ? null : values[7].ToString(),
                    Precio = values[8] == DBNull.Value ? 0m : decimal.Parse(values[8].ToString())
                };
            }
        }
}
